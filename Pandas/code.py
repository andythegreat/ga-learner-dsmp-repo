...
print('categorical_var is ')
print(categorical_var)

numerical_var = bank.select_dtypes(include = 'number')
print('numerical_var is ')
print(numerical_var)
...
#banks['Loan_Amount_Term_Year'] = banks['Loan_Amount_Term'].apply(lambda x:convertToYear(x))
#print(banks)
...
# --------------
# code starts here
print ('---------------------Group by loan status')
loan_groupby=banks.groupby('Loan_Status')
loan_groupby=loan_groupby[['ApplicantIncome', 'Credit_History']]
mean_values = loan_groupby.mean()
print(loan_groupby.mean())
